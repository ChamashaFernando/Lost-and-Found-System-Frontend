...
//     setLoading(true);
//     try {
//       const response = await axios.get(`http://172.20.10.3:8096/api/found/user/${userId}`, {
...
//   container: { flex: 1, padding: 10, backgroundColor: '#ecf3fc' },
...
//     padding: 12 
//   },
//   description: { fontSize: 14, marginBottom: 5, color: '#333' },
//   location: { fontSize: 13, fontStyle: 'italic', color: '#555', marginBottom: 5 },
//   date: { fontSize: 12, color: '#888', marginBottom: 8 },
//   photo: { width: '100%', height: 200, borderRadius: 10, marginTop: 5 },
//   noReportsText: { textAlign: 'center', marginTop: 30, fontSize: 16, color: '#555' },
// });
