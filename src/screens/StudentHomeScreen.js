...
//         <TouchableOpacity onPress={handleMyReports} style={{ marginTop: 10 }}>
//           <LinearGradient colors={['#4a90e2', '#3578c6']} style={styles.gradientButton}>
...
// import LinearGradient from 'react-native-linear-gradient';
// import axios from 'axios';
// import { createChatSession } from '../api/chat'; // 🔹 updated import
...
//     try {
//       const adminId = 1; // 🔹 replace with your admin/support user ID
//       const session = await createChatSession(user.id, adminId, token);
//       navigation.navigate('Chat', { session, user, token });
//     } catch (err) {
//       console.error("Chat session creation error:", err);
//       Alert.alert("Error", "Chat start කරන්න බැහැ.");
//     }
//   };
